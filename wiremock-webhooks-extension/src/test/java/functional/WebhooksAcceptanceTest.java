...
public class WebhooksAcceptanceTest {
    ...
    public void firesASingleWebhookWhenRequested() throws Exception {
        rule.stubFor(post(urlPathEqualTo("/something-async"))
            ...
            .withPostServeAction("webhook", webhook()
                .withMethod(POST)
                .withUrl("http://localhost:" + targetServer.getRuntimeInfo().getHttpPort() + "/callback")
    ...
    public void webhookCanBeConfiguredFromJson() throws Exception {
        ...
        client.postJson("/__admin/mappings", "{\n" +
                ...
                "        \"method\": \"POST\",\n" +
                "        \"body\": \"{ \\\"result\\\": \\\"SUCCESS\\\" }\",\n" +
                "        \"url\" : \"http://localhost:" + targetServer.getRuntimeInfo().getHttpPort() + "/callback1\"\n" +
                "      }\n" +
                "    },\n" +
                "    {\n" +
                "      \"name\": \"webhook\",\n" +
                "      \"parameters\": {\n" +
                "        \"method\": \"POST\",\n" +
                "        \"url\" : \"http://localhost:" + targetServer.getRuntimeInfo().getHttpPort() + "/callback2\"\n" +
                "      }\n" +
                "    }\n" +
                "  ]\n" +
                "}");
    ...
    public void appliesTemplatingToUrlMethodHeadersAndBodyViaDSL() throws Exception {
        rule.stubFor(post(urlPathEqualTo("/templating"))
                ...
                .withPostServeAction("webhook", webhook()
                        ...
                        .withUrl("http://localhost:" + targetServer.getRuntimeInfo().getHttpPort() + "{{{jsonPath originalRequest.body '$.callbackPath'}}}")
    ...
    public void appliesTemplatingToUrlMethodHeadersAndBodyViaJSON() throws Exception {
        client.postJson("/__admin/mappings", "{\n" +
                ...
                "      \"url\" : \"" + "http://localhost:" + targetServer.getRuntimeInfo().getHttpPort() + "{{{jsonPath originalRequest.body '$.callbackPath'}}}\",\n" +
                "      \"headers\" : {\n" +
                "        \"X-Single\" : \"{{math 1 '+' 2}}\",\n" +
    ...
    public void addsRandomDelayViaJSON() throws Exception {
        client.postJson("/__admin/mappings", "{\n" +
                ...
                "    \"parameters\" : {\n" +
                "      \"method\" : \"GET\",\n" +
                "      \"url\" : \"" + "http://localhost:" + targetServer.getRuntimeInfo().getHttpPort() + "/callback\",\n" +
                "      \"delay\" : {\n" +
                "        \"type\" : \"uniform\",\n" +
                "        \"lower\": 500,\n" +
                "        \"upper\": 1000\n" +
