...
public class NettyClientFactory implements HttpClientFactory {

  @Override
  public String getName() {
    return "netty-client-factory";
  }

  @Override
  public com.github.tomakehurst.wiremock.http.client.HttpClient buildHttpClient(
      Options options,
      boolean trustAllCertificates,
      List<String> trustedHosts,
      boolean useSystemProperties) {
    final reactor.netty.http.client.HttpClient nettyHttpClient =
        createClient(
    ...
    return new NettyBackedHttpClient(nettyHttpClient, options.shouldPreserveUserAgentProxyHeader());
  }

  public static reactor.netty.http.client.HttpClient createClient() {
    return createClient(HttpClientFactory.DEFAULT_TIMEOUT);
  }

  public static reactor.netty.http.client.HttpClient createClient(int timeoutMilliseconds) {
    return createClient(
  ...
  public static reactor.netty.http.client.HttpClient createClient(
      ...
      String userAgent) {
    return StaticNettyClientFactory.createClient(
        maxConnections,
        timeoutMilliseconds,
        proxySettings,
        trustStoreSettings,
