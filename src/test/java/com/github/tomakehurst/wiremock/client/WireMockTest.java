...
public class WireMockTest {
    @Test
    public void createEqualToXmlPatternWithPlaceholder() {
        ...
        EqualToXmlPattern equalToXmlPattern = WireMock.equalToXml("<a/>", enablePlaceholders, placeholderOpeningDelimiterRegex, placeholderClosingDelimiterRegex);
