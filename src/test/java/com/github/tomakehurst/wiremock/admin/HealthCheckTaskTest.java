...
public class HealthCheckTaskTest {
    ...
    public void setUp() {
        ...
        healthCheckTask = new HealthCheckTask();
    }
    
    @Test
    public void healthy() {
        context.checking(new Expectations() {{
            oneOf(mockAdmin).isHealthy();
            will(returnValue(false));
        }});
  
        ResponseDefinition execute = healthCheckTask.execute(mockAdmin, mockRequest, PathParams.empty());
        assertEquals(500, execute.getStatus());
    }
