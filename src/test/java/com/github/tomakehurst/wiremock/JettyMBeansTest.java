...
import static com.github.tomakehurst.wiremock.common.NetworkUtils.acquireRandomPort;
...
import com.github.tomakehurst.wiremock.common.NetworkUtils;
...
public class JettyMBeansTest {
     ...
     */
    private static final int JMX_PORT = 9998;
    /**
...
//	@Ignore("See comments for high maintenance test setup")
    ...
    public void canFindJettyMBeans() throws IOException {
        int jmxPort = JMX_PORT;
//        int jmxPort = acquireRandomPort();
        System.setProperty("com.sun.management.jmxremote","");
        System.setProperty("com.sun.management.jmxremote.ssl", "false");
        System.setProperty("com.sun.management.jmxremote.authenticate","false");
        System.setProperty("com.sun.management.jmxremote.port", String.valueOf(jmxPort));

        WireMockConfiguration wireMockConfiguration = new WireMockConfiguration().enableJettyMBeans(true);
        wireMockServer = new WireMockServer(options().dynamicPort().enableJettyMBeans(true));
