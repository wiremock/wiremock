...
public class DateTimeOffsetTest {
    ...
    public void shiftsZonedDateTimes() {
        ...
        assertThat(positiveDateOffset.shift(ZonedDateTime.parse("2021-06-18T00:00:00Z")),
                   is(ZonedDateTime.parse("2021-06-28T00:00:00Z")));

        DateTimeOffset negativeDateOffset = new DateTimeOffset(-4, DateTimeUnit.MONTHS);
        assertThat(negativeDateOffset.shift(ZonedDateTime.parse("2021-06-18T00:00:00Z")),
