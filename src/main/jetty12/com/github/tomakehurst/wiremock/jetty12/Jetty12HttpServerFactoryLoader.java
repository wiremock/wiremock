...
public class Jetty12HttpServerFactoryLoader implements JettyHttpServerFactoryLoader {
    ...
    if (JETTY_12.equalsIgnoreCase(jettyMajorVersion)) {
      return Optional.of(
          (options, adminRequestHandler, stubRequestHandler) ->
              new Jetty12HttpServer(options, adminRequestHandler, stubRequestHandler));
    } else {
