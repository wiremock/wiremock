...
/**
 * An admin task to reset all scenarios to their initial state.
 *
 * <p>This task handles the API request to reset the state of all scenarios, which is useful for
