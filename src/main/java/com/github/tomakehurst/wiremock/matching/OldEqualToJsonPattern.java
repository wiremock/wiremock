...
public class OldEqualToJsonPattern extends StringValuePattern {
    ...
    public OldEqualToJsonPattern(@JsonProperty("equalToJson") String json,
    ...
    public OldEqualToJsonPattern(JsonNode jsonNode,
