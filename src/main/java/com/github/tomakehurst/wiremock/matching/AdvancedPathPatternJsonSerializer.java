...
public abstract class AdvancedPathPatternJsonSerializer<T extends PathPattern>
  ...
  public void serializePathPattern(T value, JsonGenerator gen, SerializerProvider serializers)
      throws IOException {
    if (value.isSimple()) {
