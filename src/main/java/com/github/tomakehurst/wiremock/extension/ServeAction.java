...
public abstract class ServeAction implements Extension {

  /**
   * Do something when a specific request is being served.
   *
  ...
  /**
   * Do something when any request is being served.
   *
   * @param serveEvent the serve event, including the request and the response definition
   * @param admin WireMock's admin functions
   */
