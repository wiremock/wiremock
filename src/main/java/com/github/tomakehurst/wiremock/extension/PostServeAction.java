...
public abstract class PostServeAction implements Extension, AdminApiExtension {

    /**
     * Conveniently defaults to adding no new admin API routes.
     * @see AdminApiExtension#contributeAdminApiRoutes(Router)
