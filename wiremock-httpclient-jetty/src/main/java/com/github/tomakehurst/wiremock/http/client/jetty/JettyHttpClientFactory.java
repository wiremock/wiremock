...
public class JettyHttpClientFactory implements HttpClientFactory {
  ...
  public HttpClient buildHttpClient(
    ...
    final org.eclipse.jetty.client.HttpClient jettyClient =
        createClient(
    ...
    return new JettyBackedHttpClient(jettyClient, options.shouldPreserveUserAgentProxyHeader());
  }

  public static org.eclipse.jetty.client.HttpClient createClient() {
    return createClient(HttpClientFactory.DEFAULT_TIMEOUT);
  }

  public static org.eclipse.jetty.client.HttpClient createClient(int timeoutMilliseconds) {
    return createClient(
  ...
  public static org.eclipse.jetty.client.HttpClient createClient(
      ...
      String userAgent) {
    return StaticJettyHttpClientFactory.createClient(
        maxConnections,
        timeoutMilliseconds,
        proxySettings,
        trustStoreSettings,
