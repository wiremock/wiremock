...
public class MessageHeadersJsonSerializer extends JsonSerializer<MessageHeaders> {
  ...
  @Override
  public void serialize(MessageHeaders headers, JsonGenerator jgen, SerializerProvider provider)
      throws IOException {
  ...
  @Override
  public boolean isEmpty(SerializerProvider provider, MessageHeaders value) {
    return value.size() == 0;
  }
}
