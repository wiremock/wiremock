...
public class EditMessageStubMappingTask extends AbstractSingleMessageStubTask {
  ...
  protected ResponseDefinition processStubMapping(
    ...
    MessageStubMapping updated =
        Json.read(serveEvent.getRequest().getBodyAsString(), MessageStubMapping.class)
            .transform(b -> b.withId(stubMapping.getId()));
    admin.editMessageStubMapping(updated);
