...
@PublishedAPI
public class MessageHeader extends MultiValue {

  public MessageHeader(String key, String... values) {
    super(key, asList(values));
  }

  public MessageHeader(String key, Collection<String> values) {
    super(key, List.copyOf(getFirstNonNull(values, Collections.emptyList())));
  }

  public static MessageHeader messageHeader(String key, String... values) {
    return new MessageHeader(key, values);
  }

  public static MessageHeader absent(String key) {
